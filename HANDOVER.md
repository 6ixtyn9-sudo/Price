...
- 9 new tests appended to existing suite files (6 provenance in `test_warehouse.py`, 3 lane in `test_attribution.py`). Suite: 614 passed on canonical repo (613 + 1 env-skip in the agent sandbox).
